...
def args_parser():
    ...
    # federated arguments
    parser.add_argument('--rounds', type=int, default=201, help="rounds of training")
    ...
    parser.add_argument('--partition', type=str, default='flag-non-iid', help='method of partitioning')
    parser.add_argument('--alg', type=str, default='pacfl', help='Algorithm')
    parser.add_argument('--beta', type=float, default=1.0, help='The parameter for the dirichlet distribution for data'\
                        'partitioning')
    ...
    parser.add_argument('--cluster_alpha', type=float, default=1.37, help="the clustering threshold")
    parser.add_argument('--n_basis', type=int, default=3, help="number of basis per label")
